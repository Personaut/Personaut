...
const NativeIDEProvider_1 = require("./NativeIDEProvider");
...
describe('NativeIDEProvider', () => {
    ...
    beforeEach(() => {
        ...
        provider = new NativeIDEProvider_1.NativeIDEProvider();
        mockModel = {
            name: 'gpt-4',
            family: 'gpt-4',
            vendor: 'copilot',
    ...
    describe('chat method', () => {
        ...
        it('should handle conversation history', async () => {
            ...
            const userMessageCalls = vscode.LanguageModelChatMessage.User.mock.calls;
            const assistantMessageCalls = vscode.LanguageModelChatMessage.Assistant.mock.calls;
        ...
        it('should filter out error messages from history', async () => {
            ...
            const userMessageCalls = vscode.LanguageModelChatMessage.User.mock.calls;
            const errorMessages = userMessageCalls.filter((call) => call[0] === 'Something went wrong');
        ...
        it('should handle model selection timeout', async () => {
            mockLm.selectChatModels.mockImplementation(() => new Promise((resolve) => setTimeout(() => resolve([mockModel]), 15000)));
            const history = [{ role: 'user', text: 'Hello' }];
            const systemPrompt = 'You are a helpful assistant';
            const response = await provider.chat(history, systemPrompt);
...
//# sourceMappingURL=NativeIDEProvider.test.js.map