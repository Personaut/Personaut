...
class ErrorSanitizer {
    ...
    sanitize(error, context) {
        ...
        const containedSensitiveInfo = this.containsSensitiveInfo(errorMessage) ||
        ...
        const userMessage = this.createUserMessage(errorMessage, classification, containedSensitiveInfo);
     ...
     */
    createLogMessage(message, stack, context) {
        const parts = [];
        if (context) {
     ...
     */
    createUserMessage(message, classification, containedSensitiveInfo) {
