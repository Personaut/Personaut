...
const PersonasHandler_1 = require("./PersonasHandler");
// Mock dependencies
jest.mock('../services/PersonasService');
describe('PersonasHandler', () => {
    let personasHandler;
    let mockPersonasService;
    ...
    beforeEach(() => {
        ...
        personasHandler = new PersonasHandler_1.PersonasHandler(mockPersonasService, mockInputValidator);
    });
...
//# sourceMappingURL=PersonasHandler.test.js.map